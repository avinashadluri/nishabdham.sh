    ...
    <div className="min-h-[86.5vh] flex flex-col justify-center items-center text-center">
      <section className="p-2">
        <h1 className="text-4xl font-bold mb-4 sm:text-7xl flex flex-col items-center gap-2">
          ...
          <Image
            ...
            priority
          />
          <span className="text-gray-600 -mt-12 bg-gradient-to-r from-slate-800 to-slate-600 bg-clip-text text-transparent py-[2px] leading-relaxed">నా ఆలోచనల ప్రపంచం</span>
        </h1>
      ...
      <section className="p-10 bg-gray-100">
          <div className="w-full">
            ...
            <div className="text-lg text-gray-700 w-full mb-12 text-center">
              ...
              నా రచనలన్నీ నా అనుభవాలతో, నా మనసులోని భావాలతో రాశాను. 
              చదివి ఆనందించండి.
            </div>
      ...
      <section className="p-10 bg-gray-50">
          <div className="w-full">
            ...
            <div className="text-lg text-gray-700 w-full mb-12 text-center">
            ప్రతి ఆలోచనా ధోరణి మన అవగాహనను విస్తృతం చేస్తుంది. వివిధ కోణాల నుండి విషయాలను అర్థం చేసుకోవడం ద్వారా మన దృక్పథం సమగ్రమవుతుంది.
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {thoughts.map((thought, index) => (
              <div key={index} className="bg-white dark:bg-neutral-900 p-6 rounded-lg shadow-sm hover:shadow-md transition-all">
                <div className="flex flex-col gap-4">
                  ...
                  <ul className="list-disc space-y-2 text-left pl-4">
                    {thought.thoughts.map((item, itemIndex) => (
                      <li key={itemIndex} className="text-gray-600 dark:text-gray-400 text-left">
                        {item}
                      </li>
                    ))}
                  </ul>
        ...
        <section className="p-10 bg-gray-100">
          <div className="w-full">
            ...
            <div className="text-lg text-gray-700 w-full mb-12 text-center">
            రచన అనేది మన మనసు నుండి ప్రవహించే భావధార. అక్షరాల ద్వారా మన అనుభూతులు అనంతకాలం జీవించగలవు. ప్రతి పదం వెనుక ఒక కథ, ప్రతి వాక్యం వెనుక ఒక అనుభవం దాగి ఉంటుంది.
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {motivation.map((item, index) => (
              <div key={index} className="bg-white dark:bg-neutral-900 p-6 rounded-lg shadow-sm hover:shadow-md transition-all border border-gray-200 dark:border-gray-800">
                <div className="flex flex-col gap-4">
                  <div className="flex items-center gap-2">
                    {item.icon}
                  ...
                  <blockquote className="border-l-4 border-gray-200 dark:border-gray-700 pl-4 italic">
                    <p className="text-gray-600 dark:text-gray-400 mb-2">{item.quote}</p>
